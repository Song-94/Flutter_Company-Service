...
final statusLevel = [
  ...
  StatusModel(
    ...
    detailFontColor: Colors.black,
    imagePath: SCREEN_DUST_MEDIOCRE,
    comment: '나쁘지 않네요!',
    minFineDust: 41,
    minUltraFineDust: 21,
    minO3: 0.06,
  ...
  StatusModel(
    ...
    detailFontColor: Colors.black,
    imagePath: SCREEN_DUST_VERY_BAD,
